...
(function () {
    ...
    CKEDITOR.tools.extend(CKEDITOR.fileTools, {
        addUploadWidget: function (b, c, a) {
            var f = CKEDITOR.fileTools, k = b.uploadRepository, m = a.supportedTypes ? 10 : 20;
            if (a.fileToElement)b.on("paste", function (i) {
                var i = i.data, l = i.dataTransfer, e = l.getFilesCount(), j = a.loadMethod || "loadAndUpload",
                    d, g;
                if (!i.dataValue && e)for (g = 0; g < e; g++) {
                    d = l.getFile(g);
            ...
            CKEDITOR.tools.extend(a, {
                downcast: function () {
                    ...
                    var a = this, c = this.wrapper.findOne("[data-cke-upload-id]").data("cke-upload-id"),
                        e = k.loaders[c], f = CKEDITOR.tools.capitalize, d, g;
                    ...
                    e.update()
                                          ...
                                          c) {
                    if (a.trim() === "")b.widgets.del(this); else {
                        var e = this == b.widgets.focused, f = b.editable(), d = b.createRange(), g, h;
