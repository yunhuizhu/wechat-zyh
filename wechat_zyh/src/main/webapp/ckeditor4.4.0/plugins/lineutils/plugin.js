...
(function () {
    ...
    k.prototype = {
        start: function (a) {
            ...
            this.relations =
            {};
            for (var a = this.editable.getElementsByTag("*"), d = 0, b, c, e; b = a.getItem(d++);)if (!b.equals(this.editable) && b.type == CKEDITOR.NODE_ELEMENT && (b.hasAttribute("contenteditable") || !b.isReadOnly()) && j(b) && b.isVisible())for (e in this.lookups)(c = this.lookups[e](b)) && this.store(b, c);
    ...
    l.prototype = {
        locate: function () {
            function a(a, b) {
                ...
                return c && j(c) ? (a.siblingRect = c.getClientRect(), b == CKEDITOR.LINEUTILS_BEFORE ? (a.siblingRect.bottom +
                a.elementRect.top) / 2 : (a.elementRect.bottom + a.siblingRect.top) / 2) : b == CKEDITOR.LINEUTILS_BEFORE ? a.elementRect.top : a.elementRect.bottom
            }
