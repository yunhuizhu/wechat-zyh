...
public class VerifyCodeUtils {
    ...
    private static String fontName = "Algerian";// 字体名称
    private static double rotate = 5;// 文字旋转幅度(数值越小幅度越大)
     ...
     */
    private static String outputVerifyImage(int w, int h, File outputFile,
    ...
    public static void outputImage(int w, int h, OutputStream os, String code)
        ...
        int fontSize = h - 4;
        Font font = new Font(fontName, Font.ITALIC, fontSize);// 字体/风格/大小
        g2.setFont(font);
        char[] chars = code.toCharArray();
        for (int i = 0; i < verifySize; i++) {
            AffineTransform affine = new AffineTransform();
            affine.setToRotation(
                    Math.PI / rotate * rand.nextDouble()
